 ...
 * <!-- end-user-doc -->
 * @see xtext.robocode.generator.GeneratorPackage#getEventType()
 * @model
 * @generated
 */
public enum EventType implements Enumerator
{
   ...
   * @ordered
   */
  BULLET_HIT(0, "BulletHit", "BulletHit"),
   ...
   * @ordered
   */
  public static final int BULLET_HIT_VALUE = 0;
  ...
  public static EventType get(int value)
  {
    switch (value)
    {
      case BULLET_HIT_VALUE: return BULLET_HIT;
      case BULLET_MISSED_VALUE: return BULLET_MISSED;
      case DEATH_VALUE: return DEATH;
      case HIT_BY_BULLET_VALUE: return HIT_BY_BULLET;
      case HIT_ROBOT_VALUE: return HIT_ROBOT;
      case HIT_WALL_VALUE: return HIT_WALL;
      case SCANNED_ROBOT_VALUE: return SCANNED_ROBOT;
