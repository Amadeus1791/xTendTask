 ...
 * </p>
 * <ul>
 *   <li>{@link xtext.robocode.generator.impl.ArenaImpl#getRobot <em>Robot</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArenaImpl extends MinimalEObjectImpl.Container implements Arena
{
  ...
  {
    return GeneratorPackage.Literals.ARENA;
  }
  ...
  public EList<Robot> getRobot()
  {
    if (robot == null)
    {
      robot = new EObjectContainmentEList<Robot>(Robot.class, this, GeneratorPackage.ARENA__ROBOT);
    }
    return robot;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case GeneratorPackage.ARENA__ROBOT:
